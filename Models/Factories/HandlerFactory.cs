...
namespace cumcad.Models.Factories
{
    ...
    {
        // viewed list
        internal static List<string> StringItems = new List<string>() { "ExtractImage", "InRange", "InRangeGray", "Resize", "RejectBorders", "RotateImage", "CvtColor", "CountNonZero", "BitwiseNot", "BitwiseOr/And" };
        // real names
        internal static List<string> StringItemsRealNames = new List<string>() { "ExtractImage", "InRange", "InRangeGray", "Resize", "RejectBorders", "RotateImage", "CvtColor", "CountNonZero", "BitwiseNot", "BitwiseOrAnd" };
